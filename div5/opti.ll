...
2:                                                ; preds = %2, %0
  ...
  call void @_Z4funciiiiiiiiiiiiiiii(i32 %4, i32 %5, i32 %6, i32 %7, i32 %8, i32 %9, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef)
  %10 = add nuw nsw i32 %3, 1
  %11 = icmp eq i32 %10, 1000
  br i1 %11, label %1, label %2
}
