...
for.body:                                         ; preds = %for.cond
  ...
  store i32 %add16, ptr %arrayidx18, align 4
  ...
  %31 = load i32, ptr %a11.addr, align 4
  %32 = load i32, ptr %a12.addr, align 4
  %add28 = add nsw i32 %31, %32
  %33 = load i32, ptr %i, align 4
  %idxprom29 = sext i32 %33 to i64
  %arrayidx30 = getelementptr inbounds [100000 x i32], ptr @b11, i64 0, i64 %idxprom29
  store i32 %add28, ptr %arrayidx30, align 4
  %34 = load i32, ptr %a12.addr, align 4
  %35 = load i32, ptr %a13.addr, align 4
  %add31 = add nsw i32 %34, %35
  %36 = load i32, ptr %i, align 4
  %idxprom32 = sext i32 %36 to i64
  %arrayidx33 = getelementptr inbounds [100000 x i32], ptr @b12, i64 0, i64 %idxprom32
  store i32 %add31, ptr %arrayidx33, align 4
  %37 = load i32, ptr %a13.addr, align 4
  %38 = load i32, ptr %a14.addr, align 4
  %add34 = add nsw i32 %37, %38
  %39 = load i32, ptr %i, align 4
  %idxprom35 = sext i32 %39 to i64
  %arrayidx36 = getelementptr inbounds [100000 x i32], ptr @b13, i64 0, i64 %idxprom35
  store i32 %add34, ptr %arrayidx36, align 4
  %40 = load i32, ptr %a14.addr, align 4
  %41 = load i32, ptr %a15.addr, align 4
  %add37 = add nsw i32 %40, %41
  %42 = load i32, ptr %i, align 4
  %idxprom38 = sext i32 %42 to i64
  %arrayidx39 = getelementptr inbounds [100000 x i32], ptr @b14, i64 0, i64 %idxprom38
  store i32 %add37, ptr %arrayidx39, align 4
  %43 = load i32, ptr %a15.addr, align 4
  %44 = load i32, ptr %a16.addr, align 4
  %add40 = add nsw i32 %43, %44
  %45 = load i32, ptr %i, align 4
  %idxprom41 = sext i32 %45 to i64
  %arrayidx42 = getelementptr inbounds [100000 x i32], ptr @b15, i64 0, i64 %idxprom41
  store i32 %add40, ptr %arrayidx42, align 4
  %46 = load i32, ptr %a16.addr, align 4
  %47 = load i32, ptr %a1.addr, align 4
  %add43 = add nsw i32 %46, %47
  %48 = load i32, ptr %i, align 4
  %idxprom44 = sext i32 %48 to i64
  %arrayidx45 = getelementptr inbounds [100000 x i32], ptr @b16, i64 0, i64 %idxprom44
  store i32 %add43, ptr %arrayidx45, align 4
  %49 = load i32, ptr %a16.addr, align 4
  %50 = load i32, ptr %a2.addr, align 4
  %add46 = add nsw i32 %49, %50
  %51 = load i32, ptr %i, align 4
  %idxprom47 = sext i32 %51 to i64
  %arrayidx48 = getelementptr inbounds [100000 x i32], ptr @b17, i64 0, i64 %idxprom47
  store i32 %add46, ptr %arrayidx48, align 4
  %52 = load i32, ptr %a16.addr, align 4
  %53 = load i32, ptr %a3.addr, align 4
  %add49 = add nsw i32 %52, %53
  %54 = load i32, ptr %i, align 4
  %idxprom50 = sext i32 %54 to i64
  %arrayidx51 = getelementptr inbounds [100000 x i32], ptr @b18, i64 0, i64 %idxprom50
  store i32 %add49, ptr %arrayidx51, align 4
  %55 = load i32, ptr %a16.addr, align 4
  %56 = load i32, ptr %a4.addr, align 4
  %add52 = add nsw i32 %55, %56
  %57 = load i32, ptr %i, align 4
  %idxprom53 = sext i32 %57 to i64
  %arrayidx54 = getelementptr inbounds [100000 x i32], ptr @b19, i64 0, i64 %idxprom53
  store i32 %add52, ptr %arrayidx54, align 4
  %58 = load i32, ptr %a16.addr, align 4
  %59 = load i32, ptr %a5.addr, align 4
  %add55 = add nsw i32 %58, %59
  %60 = load i32, ptr %i, align 4
  %idxprom56 = sext i32 %60 to i64
  %arrayidx57 = getelementptr inbounds [100000 x i32], ptr @b20, i64 0, i64 %idxprom56
...
for.body:                                         ; preds = %for.cond
  ...
  %17 = load i32, ptr @b1, align 16
  %18 = load i32, ptr @b1, align 16
  %19 = load i32, ptr @b1, align 16
  %20 = load i32, ptr @b1, align 16
  %21 = load i32, ptr @b1, align 16
  %22 = load i32, ptr @b1, align 16
  %23 = load i32, ptr @b1, align 16
  %24 = load i32, ptr @b1, align 16
  %25 = load i32, ptr @b1, align 16
  %26 = load i32, ptr @b1, align 16
  %27 = load i32, ptr @b1, align 16
  %28 = load i32, ptr @b1, align 16
  %29 = load i32, ptr @b1, align 16
  %30 = load i32, ptr @b1, align 16
  %31 = load i32, ptr @b1, align 16
